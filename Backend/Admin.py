...
with app.app_context():
    ...
    if not Credential.query.filter_by(user_id="Admin").first():
        ...
        first_customer_id = IDs(rejection_id="24ASZRA0",customer_id="24ASZCA0",category_id="24ASZCAA0", professional_id="24ASZPA0",service_id="24ASZSA0",booking_id="24ASZBA0")
